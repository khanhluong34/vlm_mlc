...
class GNN(nn.Module):
    def __init__(self, backbone):
        ...
        if backbone == 'RN50':
            ...
            self.gc3 = GraphConvolution(2048, 2048)
            self.gc4 = GraphConvolution(2048, 1024)
            ...
            self.gc3 = GraphConvolution(2048, 2048)
            self.gc4 = GraphConvolution(2048, 1024)
            self.gc5 = GraphConvolution(1024, 512)
...
class SCPNet(nn.Module):
    ...
    def __init__(self, classnames, clip_model):
        ...
        if cfg.backbone == 'RN50':
            ...
            self.gc2 = GraphConvolution(2048, 2048)
            self.gc3 = GraphConvolution(2048, 1024)
            # self.gc1 = GNN(cfg.backbone)
            # self.gc2 = GNN(cfg.backbone)
            # self.gc3 = GNN(cfg.backbone)
